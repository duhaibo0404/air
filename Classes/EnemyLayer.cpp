...
void EnemyLayer::addEnemy1(float dt)
{
	...
	enemy1->bindSprite(Sprite::createWithSpriteFrame(enemy1SpriteFrame), ENEMY1_MAXLIFE, ENEMY_TYPE_1);
...
void EnemyLayer::addEnemy2(float dt)
{
	...
	enemy2->bindSprite(Sprite::createWithSpriteFrame(enemy2SpriteFrame), ENEMY2_MAXLIFE, ENEMY_TYPE_2);
...
void EnemyLayer::addEnemy3(float dt)
{
	...
	enemy3->bindSprite(Sprite::createWithSpriteFrame(enemy3SpriteFrame_1), ENEMY3_MAXLIFE, ENEMY_TYPE_3);
