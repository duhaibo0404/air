...
void C2DXShareSDK::open(__String *appKey, bool useAppTrusteeship)
{
...
void C2DXShareSDK::shareContent(C2DXPlatType platType, __Dictionary *content, C2DXShareResultEvent callback)
{
#if CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID
...
void C2DXShareSDK::oneKeyShareContent(__Array *platTypes, __Dictionary *content, C2DXShareResultEvent callback)
{
#if CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID
...
void C2DXShareSDK::showShareMenu(__Array *platTypes, __Dictionary *content, Vec2 pt, C2DXMenuArrowDirection direction, C2DXShareResultEvent callback)
{
#if CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID
