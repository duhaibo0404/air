...
namespace cn
{
    namespace sharesdk
    {
        ...
        public:
             ...
             */
            static void open(__String *appKey, bool useAppTrusteeship);
             ...
             *	@param 	callback 	回调方法
             */
            static void shareContent(C2DXPlatType platType, __Dictionary *content, C2DXShareResultEvent callback);
             ...
             *	@param 	callback 	回调方法
             */
            static void oneKeyShareContent(__Array *platTypes, __Dictionary *content, C2DXShareResultEvent callback);
             ...
             *	@param 	callback 	回调方法
             */
            static void showShareMenu(__Array *platTypes, __Dictionary *content, Vec2 pt, C2DXMenuArrowDirection direction, C2DXShareResultEvent callback);
